...
static int __pyx_m_clear(PyObject *m) {
  ...
  Py_CLEAR(clear_module_state->__pyx_n_b_aaa);
...
static int __pyx_m_traverse(PyObject *m, visitproc visit, void *arg) {
  ...
  Py_VISIT(traverse_module_state->__pyx_n_b_aaa);
...
#define __pyx_n_b_aaa __pyx_mstate_global->__pyx_n_b_aaa
 ...
 *     return "aaa"             # <<<<<<<<<<<<<<
 */
  __pyx_t_3 = __pyx_convert_string_from_py_std__in_string(__pyx_n_b_aaa); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 108, __pyx_L1_error)
  __pyx_r = __pyx_t_3;
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_WriteUnraisable("variantpost.processor_wrapper.test_it", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {0, __pyx_k_aaa, sizeof(__pyx_k_aaa), 0, 0, 0, 1},
...
static CYTHON_SMALL_CODE int __Pyx_InitGlobals(void) {
  ...
  if (__Pyx_InitString(__pyx_string_tab[1], &__pyx_n_b_aaa) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[2], &__pyx_n_s_cline_in_traceback) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[3], &__pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[4], &__pyx_n_s_name) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[5], &__pyx_n_s_print) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  if (__Pyx_InitString(__pyx_string_tab[6], &__pyx_n_s_test) < 0) __PYX_ERR(0, 1, __pyx_L1_error);
  #endif
  #if !CYTHON_USE_MODULE_STATE
